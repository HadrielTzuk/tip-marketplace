...
#              CONSTANTS              #
# =====================================
CONNECTOR_NAME = "Exchange EML Connector v2"
DEFAULT_DIVIDER = ","
...
def main(test_run):
    ...
    use_domain_in_auth = extract_connector_param(connector_scope, param_name="Use Domain For Authentication",
                                                 input_type=bool, default_value=False)
    domain = extract_connector_param(connector_scope, param_name="Domain", is_mandatory=True)
    username = extract_connector_param(connector_scope, param_name="Username", is_mandatory=True)
    password = extract_connector_param(connector_scope, param_name="Password", is_mandatory=True)
