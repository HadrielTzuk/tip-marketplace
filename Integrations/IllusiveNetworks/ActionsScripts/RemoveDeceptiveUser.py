...
from constants import (
    INTEGRATION_NAME,
    PRODUCT_NAME,
    REMOVE_DECEPTIVE_USER_SCRIPT_NAME
)
...
def main():
    ...
    try:
        ...
        output_message = f"Action wasn't able to remove deceptive user \"{username}\". Reason: {e}"
    except Exception as e:
        output_message = f"Error executing action '{REMOVE_DECEPTIVE_USER_SCRIPT_NAME}'. Reason: {e}"
