...
from constants import INTEGRATION_NAME, INTEGRATION_DISPLAY_NAME, EXECUTE_CUSTOM_QUERY_SCRIPT_NAME, DEFAULT_RESULTS_LIMIT
...
def main():
    ...
    client_id = extract_configuration_param(
        ...
        is_mandatory=True, print_value=True, remove_whitespaces=False
    )
    ...
    # Action parameters
    custom_query = extract_action_param(siemplify, param_name="Query", print_value=True, is_mandatory=True)
    ...
    try:
        ...
        siemplify.LOGGER.error(f"General error performing action {EXECUTE_CUSTOM_QUERY_SCRIPT_NAME}")
