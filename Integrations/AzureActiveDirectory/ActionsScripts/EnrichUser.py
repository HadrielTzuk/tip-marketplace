...
from constants import ENRICH_USER_SCRIPT_NAME, INTEGRATION_NAME, ENRICH_TABLE_NAME
...
def main():
    ...
    siemplify.script_name = ENRICH_USER_SCRIPT_NAME
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                entity_report = manager.get_user(user_principal_name=entity_identifier)
                entity.additional_properties.update(entity_report.to_enrichment())
                entity.is_enriched = True
                json_results[entity_identifier] = entity_report.as_json()
        ...
        siemplify.LOGGER.error(f"General error performing action {ENRICH_USER_SCRIPT_NAME}")
        siemplify.LOGGER.exception(e)
        result_value = False
