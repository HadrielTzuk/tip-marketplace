...
from constants import INTEGRATION_NAME, FORCE_PASSWORD_UPDATE_SCRIPT_NAME
...
def main():
    ...
    siemplify.script_name = FORCE_PASSWORD_UPDATE_SCRIPT_NAME
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                manager.force_password_update(entity_identifier)
        ...
        if successful_entities:
            output_message += f"The password update was forced on following accounts : \n" \
            ...
            output_message = "No user's passwords were forced to update."
            result_value = False

    except Exception as e:
        siemplify.LOGGER.error(f"General error performing action {FORCE_PASSWORD_UPDATE_SCRIPT_NAME}")
        siemplify.LOGGER.exception(e)
