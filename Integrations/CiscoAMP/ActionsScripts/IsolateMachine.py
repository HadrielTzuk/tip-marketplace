...
SCRIPT_NAME = u"CiscoAMP - IsolateMachine"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            if computer:
                info = manager.isolate_machine(computer[u'connector_guid'])
            ...
            errors += u"Unable to isolate computer by ip {0}: \n{1}\n".format(
                entity.identifier, unicode(e))
            continue

    if enriched_entities:
        entities_names = [entity.identifier for entity in enriched_entities]
        output_message = u'The following computers isolated successfully:\n{}\n'.format('\n'.join(
            entities_names))
        ...
        output_message = u'Cisco AMP - No computers were found to isolate.\n'
        output_message += errors
