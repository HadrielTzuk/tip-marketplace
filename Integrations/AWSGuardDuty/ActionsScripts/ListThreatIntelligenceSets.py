...
def main():
    ...
    max_results_to_return = extract_action_param(siemplify, param_name="Max Threat Intelligence Sets To Return",
                                                 is_mandatory=False,
    ...
    try:
        ...
        ti_sets_ids = manager.get_threat_intelligence_sets_ids(detector_id=detector_id,
