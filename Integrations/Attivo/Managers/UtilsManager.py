...
from AttivoExceptions import AttivoException
...
def validate_response(response, error_msg='An error occurred'):
    ...
    try:
        ...
        try:
            ...
            raise AttivoException(f'{error_msg}: {error} {error.response.content}')

        raise AttivoException(
...
def convert_seconds_to_days_hours_minutes(seconds):
    ...
    :return: String with the days, hours and minutes format
    """
