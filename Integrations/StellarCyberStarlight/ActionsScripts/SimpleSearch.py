...
from StellarCyberStarlightConstants import PROVIDER_NAME, SIMPLE_SEARCH_SCRIPT_NAME, DEFAULT_LIMIT, DESCENDING_SORT
...
def main():
    ...
    siemplify.script_name = SIMPLE_SEARCH_SCRIPT_NAME
    ...
    limit = extract_action_param(siemplify, param_name='Max Results To Return', default_value=DEFAULT_LIMIT,
    ...
    sort_order = extract_action_param(siemplify, param_name='Sort Order', default_value=DESCENDING_SORT, print_value=True)
    ...
    try:
        ...
        hits = manager.make_simple_search(index=index,
                                          size=limit,
                                          query=query,
        ...
        output_message = "Error executing action \"Simple Search\". Reason: {}".format(e)
