...
def main():
    ...
    activity_display_limit = extract_action_param(siemplify, param_name="Activity Display Limit", is_mandatory=False, print_value=False, input_type=int)
    ...
    try:
            ...
            if entity.entity_type == EntityTypes.USER:
                ...
                try:
                    activities = cloud_app_manager.get_user_related_activities(
                        entity.additional_properties.get('OriginalIdentifier', entity.identifier.lower()),
                        time_frame,
                        product_name,
                    ...
                    if not activities:
                        ...
                        output_message += "User related activities for the following user were fetched:{}. \n".format(
                            entity.identifier)
                ...
                siemplify.LOGGER.info("The entity {} is not a type of USER, skipping...".format(entity.identifier))

        if no_activities:
            output_message += "\n No activities related to these users: {} were found.\n".format(", ".join([entity for entity in no_activities]))
        ...
        result_value = "false"
        output_message = 'Error executing action \"Get User Related Activities\". Reason: {}'.format(e)
