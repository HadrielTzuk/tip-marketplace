...
def main():
    ...
    status_code = ssh_wrapper.shutdown(siemplify.parameters['Wait Time'])
    if status_code == -1:
        results = 'True'
        output_message = "Successfully shutdown remote server"
    else:
        results = 'False'
        output_message = "Failed to shutdown remote server"
