...
SCRIPT_NAME = u"Get URL Reputation"
            ...
            try:
                ...
                if reputation_obj.get_blacklist_report():
                    ...
                    siemplify.result.add_data_table(
                        u"{} - Domain Blacklist Report".format(entity.identifier),
                ...
                if reputation_obj.risk_score > int(threshold):
                    siemplify.LOGGER.info(u"Entity {} has risk score of {}. Marking as suspicious.".format(
                        entity.identifier,
                        reputation_obj.risk_score
                    ))
