...
SCRIPT_NAME = u"Cancel Contain Host"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Canceling containment of host {} ({})".format(host._id, entity.identifier))
        ...
        if successful_entities:
            output_message += u"Successfully created cancel host contain task for the following entities:\n   {}".format(
