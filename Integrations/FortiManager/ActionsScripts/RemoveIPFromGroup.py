...
ACTION_NAME = 'FortiManager_RemoveIPFromGroup'
    ...
    try:
        ...
        for entity in target_entities:
            try:
                ...
                forti_manager.remove_address_object_from_address_group(adom_name, address_group_name, address_object_name)
        ...
        if success_entities:
            output_message = 'The following entities were removed from group: {0}'.format(', '.join(
                [entity.identifier for entity in success_entities]))
        else:
            output_message = 'No entities were removed from group.'
