...
from consts import SET_ALERT_SLA_SCRIPT_NAME
...
def main():
    ...
    siemplify.script_name = SET_ALERT_SLA_SCRIPT_NAME
    ...
    try:
        ...
        siemplify.LOGGER.info(u"Attempting to set alert {} of case {} with SLA.".format(
            siemplify.alert_id, siemplify.case_id)
        )
        siemplify.set_alert_sla(
            sla_period,
            sla_time_unit,
            sla_time_to_critical_period,
            sla_time_to_critical_unit
        )
        output_message = u"Alert {} of case {} was set with SLA of {} {} and critical period of {} {}.".format(
            siemplify.alert_id,
            siemplify.case_id,
            sla_period,
            sla_time_unit,
        ...
        output_message = u"Error executing action {}. Reason: {}".format(SET_ALERT_SLA_SCRIPT_NAME, e)
        result_value = False
...
def validate_sdk_version():
    ...
    """
    return hasattr(SiemplifyAction, "set_alert_sla")
