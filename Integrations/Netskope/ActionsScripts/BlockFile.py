...
BLOCKFILE_SCRIPT_NAME = '{} - BlockFile'.format(INTEGRATION_NAME)

@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = BLOCKFILE_SCRIPT_NAME
    ...
    try:
        ...
        netskope_manager.block_file(file_id, quarantine_profile_id)  
        result_value = True
        status = EXECUTION_STATE_COMPLETED
        output_message = "Successfully blocked file {}".format(file_id) 
                        
    except Exception as e: 
        output_message = "Error executing action \"BlockFile\". Reason: {}".format(e)
