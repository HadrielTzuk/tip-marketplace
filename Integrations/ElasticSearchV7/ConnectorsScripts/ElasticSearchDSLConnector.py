...
from TIPCommon import extract_connector_param, dict_to_flat, save_timestamp, get_last_success_time, is_overflowed
...
class ElasticSearchDSLConnector(object):
    ...
    def __init__(self, connector_scope, elastic_manager, device_product_field_name, event_class_id_field_name,
                 ...
                 alert_description_field, alert_severity):
    ...
    def get_alerts(self, last_run, indexes=None, query=None, alerts_count_limit=ALERTS_LIMIT):
        """
    ...
    def create_case_info(self, flat_alert, indexes, query, severity_field_name):
        """
...
def main(test=False):
    ...
    try:
        ...
        api_token = extract_connector_param(connector_scope, param_name="API Token", input_type=str)
        ...
        device_product_field_name = extract_connector_param(connector_scope, param_name="DeviceProductField",
                                                            input_type=str)
        ...
        alert_description_field = extract_connector_param(connector_scope, param_name="Alert Description Field",
                                                          input_type=str)
        ...
        environment_field_name = extract_connector_param(connector_scope, param_name="Environment Field Name",
                                                         input_type=str)
        environment_regex_pattern = extract_connector_param(connector_scope, param_name="Environment Regex Pattern",
                                                            input_type=str)
        ...
        alerts = elastic_connector.get_alerts(last_calculated_run_time.strftime(TIME_FORMAT), index, query,
                                              alerts_count_limit)
        ...
        for alert in alerts:
            try:
                ...
                case = elastic_connector.create_case_info(flat_alert, index, query, severity_field_name)
        ...
        if cases:
            try:
                ...
                connector_scope.LOGGER.error("Unable to write timestamp to file: {}".format(e))
                connector_scope.LOGGER.exception(e)
