...
SCRIPT_NAME = u"CBResponse - Unisolate Host"
            ...
            for entity in target_entities:
                ...
                try:
                    ...
                    if not sensor:
                        ...
                        continue
                    manager.unisolate_host(sensor.sensor_document_id)
                    output_message += u"Unisolated the following entity:{} \n".format(entity.identifier)
                    successful_entities.append(entity)
                    siemplify.LOGGER.info(u"Finished processing entity {0}".format(entity.identifier))
                except Exception as e:
                    output_message += u"Unable to unisolate {}: \n".format(entity.identifier)
