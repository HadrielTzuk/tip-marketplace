...
SCRIPT_NAME = u"CBResponse - Binary Free Query"
ENTITY_TABLE_HEADER = u"Binaries"
...
def main():
    ...
    try:
        ...
        if binaries:
            ...
            output_message = u"Found {} binaries.".format(len(binaries))
        else:
            output_message = u"No binaries were found."
