...
SCRIPT_NAME = u"DigitalShadows - EnrichHash"
...
def main():
    ...
    try:
        ...
        if target_entities:
            for entity in target_entities:
                ...
                try:
                    ...
                    ## enrich the entity
                    siemplify.result.add_entity_table(entity.identifier, hash_obj.to_csv())
            ...
            if failed_entities:
                output_message += u"Failed to enrich hashes:\n {0}".format("\n".join(failed_entities))
        else:
        ...
        result_value = u"false"
        output_message = u"Error executing action 'Enrich Hash'. Reason: {0}".format(e)
