...
SCRIPT_NAME = u"DigitalShadows - EnrichIp"
...
def main():
    ...
    try:
        ...
        if target_entities:
            for entity in target_entities:
                ...
                try:
                    ...
                    ## enrich the entity
                    siemplify.result.add_entity_table(entity.identifier, ip_obj.to_csv())
            ...
            if successful_entities:
                ...
                output_message += u"Successfully enriched IPs:\n {0}\n".format(
            ...
            if failed_entities:
                output_message += u"Failed to enrich IPs:\n {0}".format("\n".join(failed_entities))
        else:
        ...
        result_value = u"false"
        output_message = u"Error executing action 'Enrich IP'. Reason: {0}".format(e)
