...
def main():
    ...
    try:
        ...
        output_message = 'Successfully connected to the FireEye NX server with the provided connection parameters!'
        result = True
        status = EXECUTION_STATE_COMPLETED

    except Exception as e:
        output_message = 'Failed to connect to the FireEye NX server! Error is {}'.format(e)
        result = False
