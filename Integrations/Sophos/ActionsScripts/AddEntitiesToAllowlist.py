...
from constants import SHA256_LENGTH, INTEGRATION_NAME, INTEGRATION_DISPLAY_NAME, ADD_ENTITIES_TO_ALLOWLIST_ACTIONS_SCRIPT_NAME
    ...
    try:  
        ...
        for entity in suitable_entities:
            ...
            if len(entity.identifier) != SHA256_LENGTH:
                ...
                continue
            try:
                manager.add_hash_to_allowlist(hash_entity=entity.identifier, comment=comment)
                successful_entities.append(entity)
                
            except HashAlreadyOnBlocklist as e:
                siemplify.LOGGER.info(u"Entity {} was already on the allowlist in {}.".format(entity.identifier,INTEGRATION_NAME))
        ...
        if successful_entities:
            output_message = u"Successfully added the following entities to allowlist in {}: \n{}".format(INTEGRATION_NAME,
            ...
            result = False
            output_message = u"None of the provided entities were added to the allowlist in {}.".format(INTEGRATION_NAME)  
            
    except Exception as e:
        siemplify.LOGGER.error(u"General error performing action {}".format(ADD_ENTITIES_TO_ALLOWLIST_ACTIONS_SCRIPT_NAME))
        siemplify.LOGGER.exception(e)
        result = False
        status = EXECUTION_STATE_FAILED
        output_message = u"Error executing action {}. Reason: {}".format(ADD_ENTITIES_TO_ALLOWLIST_ACTIONS_SCRIPT_NAME, e)
