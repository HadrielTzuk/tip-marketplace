...
from constants import INTEGRATION_NAME, SCAN_ENDPOINTS_SCRIPT_NAME
...
def main():
    ...
    try:
        ...
        if successful_entities:
            output_message = u"Successfully initiated scan on the following entities in {}:" \
        ...
        siemplify.LOGGER.error(u"Error executing action {}. Reason: {}".format(SCAN_ENDPOINTS_SCRIPT_NAME, e))
        siemplify.LOGGER.exception(e)
        status = EXECUTION_STATE_FAILED
        result_value = False
        output_message = u"Error executing action {}. Reason: {}".format(SCAN_ENDPOINTS_SCRIPT_NAME, e)
