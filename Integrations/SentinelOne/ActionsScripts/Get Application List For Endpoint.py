...
def main():
    ...
    for entity in scope_entities:
        try:
            ...
            applications_list = sentinel_one_manager.get_applications_from_endpoint(agent_id, csv_output=True)
    ...
    if entities_successed:
        output_message = 'Found applications for: {0}'.format(",".join([entity.identifier for entity
