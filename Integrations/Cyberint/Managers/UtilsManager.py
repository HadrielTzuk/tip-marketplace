...
from CyberintExceptions import CyberintGeneralException
...
def validate_response(response, error_msg='An error occurred'):
    ...
    try:
        ...
        try:
            ...
            raise CyberintGeneralException(f'{error_msg}: {error} {error.response.content}')

        raise CyberintGeneralException(
