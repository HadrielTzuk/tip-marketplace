...
SCRIPT_NAME = u'RSAArcher - UpdateIncident'
...
def main():
    ...
    try:
        ...
        output_message = u"Successfully updated incident. Content ID: {}".format(content_id)
        ...
        output_message = u"Action wasn't able to update the incident. Reason: {0}".format(e)
        siemplify.LOGGER.error(output_message)

    except Exception as e:
        output_message = u'Error executing action Update Incident. Reason: {0}'.format(e)
        siemplify.LOGGER.error(u"Error executing action {}".format(SCRIPT_NAME))
        siemplify.LOGGER.exception(e)

    siemplify.LOGGER.info(u"----------------- Main - Finished -----------------")
    siemplify.LOGGER.info(
        u"\n  status: {}\n  content_id: {}\n  output_message: {}".format(result_status, content_id, output_message))
