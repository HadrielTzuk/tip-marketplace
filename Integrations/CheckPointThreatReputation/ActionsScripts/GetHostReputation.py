    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                host_reputation = manager.get_host_reputation(entity.identifier)  # Reputation Model
                siemplify.LOGGER.info("Successfully fetched data for entity {}".format(entity.identifier))

                if host_reputation.risk > threshold and \
                        host_reputation.reputation_classification.classification not in WHITE_LIST_CLASSIFICATION:
                ...
                if create_insight:
                    ...
                    siemplify.add_entity_insight(entity, message=host_reputation.as_insight(),
                                                 triggered_by=INTEGRATION_NAME)

                prefixed_file_reputation = add_prefix_to_dict(host_reputation.enriched_data_to_flatted_dict(),
                                                              ENTITY_ENRICHMENT_PREFIX)

                entity.additional_properties.update(prefixed_file_reputation)

                json_results[entity.identifier] = host_reputation.raw_response_without_status
