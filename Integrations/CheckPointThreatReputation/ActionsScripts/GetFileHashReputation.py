    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                file_reputation = manager.get_file_hash_reputation(entity.identifier)  # Reputation Model
                siemplify.LOGGER.info("Successfully fetched data for entity {}".format(entity.identifier))

                if file_reputation.risk > threshold and \
                        file_reputation.reputation_classification.classification not in WHITE_LIST_CLASSIFICATION:
                ...
                if create_insight:
                    ...
                    siemplify.add_entity_insight(entity, message=file_reputation.as_insight(),
                                                 triggered_by=INTEGRATION_NAME)

                prefixed_file_reputation = add_prefix_to_dict(file_reputation.enriched_data_to_flatted_dict(),
                                                              ENTITY_ENRICHMENT_PREFIX)

                entity.additional_properties.update(prefixed_file_reputation)

                json_results[entity.identifier] = file_reputation.raw_response_without_status
