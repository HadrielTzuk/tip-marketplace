    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Initiating scan of endpoint {}".format(entity.identifier))
                xdr_manager.scan_endpoint(endpoint.endpoint_id)
        ...
        if successful_entities:
            output_message += u"Successfully initiated scan of entities:\n   {}".format(
                u"\n   ".join([entity.identifier for entity in successful_entities])
            )
            siemplify.update_entities(successful_entities)
        else:
            output_message += u"No entities were scanned."
        ...
        if failed_entities:
            output_message += u"\n\nFailed initiated scan the following entities:\n   {}".format(
