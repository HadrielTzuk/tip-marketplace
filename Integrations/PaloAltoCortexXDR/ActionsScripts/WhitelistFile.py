    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Whitelisting hash {}".format(entity.identifier))
        ...
        if successful_entities:
            output_message += u"Successfully whitelisted the following entities:\n   {}".format(
                u"\n   ".join([entity.identifier for entity in successful_entities])
            )
            siemplify.update_entities(successful_entities)
        else:
            output_message += u"No entities were whitelisted."
