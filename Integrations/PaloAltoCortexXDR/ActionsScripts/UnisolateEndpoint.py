...
SCRIPT_NAME = u"Unisolate Endpoint"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Initiating unisolation of endpoint {}".format(entity.identifier))
                xdr_manager.unisolate_endpoint(endpoint.endpoint_id)
        ...
        if successful_entities:
            output_message += u"Successfully initiated unisolation of entities:\n   {}".format(
                u"\n   ".join([entity.identifier for entity in successful_entities])
            )
            siemplify.update_entities(successful_entities)
        else:
            output_message += u"No entities were unisolated."
        ...
        if failed_entities:
            output_message += u"\n\nFailed unisolating the following entities:\n   {}".format(
