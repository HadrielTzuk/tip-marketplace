...
SCRIPT_NAME = u"Isolate Endpoint"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Initiating isolation of endpoint {}".format(entity.identifier))
        ...
        if successful_entities:
            output_message += u"Successfully initiated isolation of entities:\n   {}".format(
        ...
        if failed_entities:
            output_message += u"\n\nFailed isolating the following entities:\n   {}".format(
