    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                siemplify.LOGGER.info(u"Restoring hash {} on endpoint {}".format(file_hash, entity.identifier))
                xdr_manager.restore_file_on_endpoint(endpoint.endpoint_id, file_hash)
        ...
        if successful_entities:
            output_message += u"Successfully restored hash {} on the following of entities:\n   {}".format(
