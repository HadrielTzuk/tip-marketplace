...
SCRIPT_NAME = "ActiveDirectory - EnableComputer"
        ...
        if target_entities:
            for entity in target_entities:
                ...
                if unix_now() >= siemplify.execution_deadline_unix_time_ms:
                    ...
                    break
                try:
                    manager.enable_computer(entity.identifier)
            ...
            if successful_entities:
                output_message += "Active Directory - Enabled computer for following entities:\n   {} \n".format(
