...
SCRIPT_NAME = "ActiveDirectory - ForcePasswordUpdate"
        ...
        if target_entities:
            for entity in target_entities:
                ...
                if unix_now() >= siemplify.execution_deadline_unix_time_ms:
                    ...
                    break
                try:
                    if manager.force_password_update(entity.identifier):
                        successful_entities.append(entity)
                    else:
                        failed_entities.append(entity)
                    siemplify.LOGGER.info("Finished processing entity {0}".format(entity.identifier))
                except Exception as e:
                    output_message += "Unable to set password for entity {}: \n{}\n".format(
            ...
            if successful_entities:
                output_message += "Active Directory - Successfully forced password update for following user:\n   " \
