...
from constants import (
    INTEGRATION_NAME,
    LIST_REFERENCE_MAPS_SCRIPT_NAME,
    LIMIT
)
...
def main():
    ...
    siemplify.script_name = LIST_REFERENCE_MAPS_SCRIPT_NAME
    ...
    try:
        ...
        reference_maps = manager.get_reference_maps(fields_to_return, filter_condition, results_limit)
        if reference_maps:
        ...
        output_message = f'Error executing {LIST_REFERENCE_MAPS_SCRIPT_NAME}. Reason {e}'
        siemplify.LOGGER.error(output_message)
        siemplify.LOGGER.exception(e)
