...
def main():
    ...
    try:
        ...
        siemplify.LOGGER.info(f"Stopping instance with ID: {instance_id}")
        operation_raw_data = manager.stop_instance(zone=instance_zone, instance_id=instance_id)
        siemplify.LOGGER.info(f"Successfully stopped instance with ID: {instance_id}")
        ...
        output_message = f"{INTEGRATION_NAME} instance {instance_id} was stopped successfully."
