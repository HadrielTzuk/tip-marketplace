...
from HumioExceptions import HumioInvalidTimeExceptionException
import time
...
def get_timestamps(range_string, start_time_string, end_time_string):
    ...
    if not start_time:
        raise HumioInvalidTimeExceptionException("\"Start Time\" should be provided, when \"Custom\" is selected in "
