...
def main():
    ...
    siemplify.script_name = "{} - {}".format(INTEGRATION_NAME, UPDATE_OU_SCRIPT_NAME)
    ...
    parent_path = extract_action_param(siemplify, param_name="OU Path", is_mandatory=True, print_value=True)
    ...
    try:
        ...
        output_message = f"Successfully updated organization unit {ou_name if ou_name else ''} for customer id {customer_id}"
    except Exception as error:
        output_message = f'Error executing action {UPDATE_OU_SCRIPT_NAME}. Reason: {error}'
