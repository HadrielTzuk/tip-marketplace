...
def main():
    ...
    #  Get scope entities.
    scope_entities = [entity for entity in siemplify.target_entities if entity.entity_type == UNIQUEUSER]

    for entity in scope_entities:

        # Get response
        res = domaintools_manager.getDomainsByEmail(entity.identifier)
        ...
        if res:
            ...
            # Enrich Entity.
            entity.additional_data.update(add_prefix_to_dict(flat_dict_res, DOMAINTOOLS_PREFIX))
