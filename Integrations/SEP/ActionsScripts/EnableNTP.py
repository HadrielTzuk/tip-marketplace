...
ACTION_NAME = "SEP - Enable NTP"
COMMAND = "sep_enable_ntp_command_id"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            if computer_id:
                siemplify.LOGGER.info("Enabling NTP on {}".format(entity.identifier))

                command_id = sep_manager.runClientCommandEnableNTP(computer_id)
    ...
    if enriched_entities:
        ...
        output_message += 'Enabling NTP on the following entities:\n' + '\n'.join(
            entities_names)
