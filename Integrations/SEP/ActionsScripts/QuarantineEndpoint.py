...
ACTION_NAME = "SEP - Quarantine Endpoint"
COMMAND = "sep_quarantine_command_id"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            if computer_id:
                siemplify.LOGGER.info("Quarantine endpoint {}".format(entity.identifier))

                command_id = sep_manager.quarantineEndpointsSoap(computer_id)
            ...
            errors += "Quarantine endpoint failed on {0}:\n{1}\n".format(entity.identifier, e.message)
    ...
    if enriched_entities:
        ...
        output_message += 'Quarantine the following endpoints:\n' + '\n'.join(
            entities_names)
