...
ACTION_NAME = "SEP - Unquarantined Endpoint"
COMMAND = "sep_unquarantine_command_id"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            if computer_id:
                siemplify.LOGGER.info("Unquarantined endpoint {}".format(entity.identifier))

                command_id = sep_manager.unQuarantineEndpointsSoap(computer_id)
            ...
            errors += "Unquarantined endpoint failed on {0}:\n{1}\n".format(entity.identifier, e.message)
    ...
    if enriched_entities:
        ...
        output_message += 'Unquarantine the following endpoints:\n' + '\n'.join(
            entities_names)
