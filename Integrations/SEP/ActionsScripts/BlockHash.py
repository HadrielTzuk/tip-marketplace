...
from SEPManager import SEP14Manager, COMPLETED, STATUS, COMMAND
...
def main():
    ...
    for entity in siemplify.target_entities:
        if entity.entity_type == EntityTypes.FILEHASH and len(
                entity.identifier) == 32 and not entity.identifier in blacklisted_hashes:
    ...
    if enriched_entities:
        ...
        output_message += 'The following hashes were blocked by Symantec Endpoint Protection:\n' + '\n'.join(
            entities_names)
