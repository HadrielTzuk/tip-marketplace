...
from TrendMicroVisionOneParser import TrendMicroVisionOneParser
import datamodels


class TrendMicroVisionOneManager:
    def __init__(self, api_root, api_token, verify_ssl, siemplify=None):
        """
        The method is used to init an object of Manager class
        Args:
            api_root (str): API root of the TrendMicroVisionOne instance
            api_token (str): API key of the TrendMicroVisionOne account
        ...
        self.parser = TrendMicroVisionOneParser()
