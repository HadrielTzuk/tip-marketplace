...
def main():
    ...
    reply_text = extract_action_param(siemplify, param_name="Reply Text", print_value=True, is_mandatory=True)
    ...
    try:
        ...
        output_message = f"Error executing action \"{ADD_TICKET_REPLY_SCRIPT_NAME}\". Reason: {error}"
