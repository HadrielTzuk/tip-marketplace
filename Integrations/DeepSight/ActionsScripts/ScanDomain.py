...
from SiemplifyUtils import get_domain_from_entity, get_domain,\
    dict_to_flat, add_prefix_to_dict_keys, flat_dict_to_csv, convert_dict_to_json_result_dict
import json

SCRIPT_NAME = "DeepSight - ScanDomain"
...
def main():
    ...
    for entity in siemplify.target_entities:
        try:
            ...
            elif entity.entity_type == EntityTypes.HOSTNAME or \
                    entity.entity_type == EntityTypes.URL:
                domain = get_domain_from_entity(entity)

            if domain:
                result = deepsight_manager.scan_domain(domain)
