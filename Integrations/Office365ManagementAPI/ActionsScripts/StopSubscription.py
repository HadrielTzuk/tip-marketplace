...
from constants import PROVIDER_NAME, STOP_SUBSCRIPTION_SCRIPT_NAME


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = STOP_SUBSCRIPTION_SCRIPT_NAME
    ...
    subscription_type = extract_action_param(siemplify, default_value="Select content type",
                                             param_name="Stop a Subscription for", is_mandatory=True, input_type=str)
    ...
    try:
        ...
        office365_manager.stop_subscription(subscription_type)
        
        output_message = "Successfully stopped O365 Management API subscription for the {} content type!".format(subscription_type)
