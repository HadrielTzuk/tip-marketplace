...
def main():
    ...
    try:
        ...
        output_message = f"Successfully connected to the {INTEGRATION_DISPLAY_NAME} installation with the provided " \
        ...
        output_message = f"Failed to connect to the {INTEGRATION_DISPLAY_NAME} installation! Error is {e}"
