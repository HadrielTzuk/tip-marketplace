...
from constants import INTEGRATION_NAME, INTEGRATION_DISPLAY_NAME, ENRICH_ENTITIES_SCRIPT_NAME
from SiemplifyDataModel import EntityTypes


SUPPORTED_ENTITY_TYPES = [EntityTypes.ADDRESS, EntityTypes.HOSTNAME]
ENRICHMENT_PREFIX = "FortiSIEM"
...
def main():
    ...
    # Action parameters
    organization = extract_action_param(siemplify, param_name="Target Organization", print_value=True)
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                device_info = manager.get_device_info(entity, organization)   
                json_results[entity.identifier] = device_info.to_json()
                entity.additional_properties.update(device_info.to_enrichment_data(prefix=ENRICHMENT_PREFIX))
                entity.is_enriched = True
                siemplify.result.add_entity_table(
                    entity.identifier,
                    flat_dict_to_csv(device_info.to_table())
                )
