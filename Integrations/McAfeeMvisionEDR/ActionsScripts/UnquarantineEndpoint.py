...
SCRIPT_NAME = u"McAfeeMvisionEDR - Unquarantine Endpoint"
...
def main():
    ...
    try:
            ...
            for host in hosts:
                if entity.identifier.lower() == host.hostname.lower() or entity.identifier in map(lambda item: item.ip,
                    ...
                    if entity not in successful_entities:
                        mvision_edr_manager.quarantine_unquarantine_endpoint(host.ma_guid, quarantine=False)
                        successful_entities.append(entity)
                        siemplify.LOGGER.info(
                            u'Successfully created unquarantine endpoint task for the entity: {}'.format(
                                entity.identifier))
        ...
        if successful_entities:
            ...
            output_message = u"Task to unquarantine wasn't created on any entities."
