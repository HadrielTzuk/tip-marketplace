...
from constants import INTEGRATION_NAME, LAUNCH_REMEDIATION_REPORT_SCRIPT_NAME
...
def main():
    ...
    all_tickets = extract_action_param(siemplify, param_name="Display Results For All tickets", input_type=bool,
    ...
    try:
        ...
        siemplify.LOGGER.error(f"General error performing action {LAUNCH_REMEDIATION_REPORT_SCRIPT_NAME}")
