...
from constants import INTEGRATION_NAME, LIST_IPS_SCRIPT_NAME
import json
...
def main():
    ...
    try:
        ...
        if ips:
            ...
            output_message = f"Successfully returned {len(ips)} IPs from {INTEGRATION_NAME}."
        else:
            output_message = f"No IPs found in {INTEGRATION_NAME}."

    except Exception as e:
        siemplify.LOGGER.error(f"General error performing action {LIST_IPS_SCRIPT_NAME}")
