...
from constants import INTEGRATION_NAME, DISCONNECT_AGENT_FROM_NETWORK_SCRIPT_NAME, UNSUCCESSFUL_ATTEMPTS_TABLE_NAME
...
def main():
    ...
    siemplify.script_name = DISCONNECT_AGENT_FROM_NETWORK_SCRIPT_NAME
    ...
    try:
        ...
        for entity in suitable_entities:
            ...
            try:
                ...
                if found_agent:
                    ...
                    siemplify.LOGGER.info("Disconnecting agent {} from network.".format(found_agent.id))
                    if sentinel_one_manager.disconnect_agent_from_network(found_agent.id):
        ...
        if success_entities:
            result_value = True
            output_message = 'The following entities were disconnected from the network: {}'\
        ...
        output_message = "Error executing action '{}'. Reason: {}".format(DISCONNECT_AGENT_FROM_NETWORK_SCRIPT_NAME, e)
