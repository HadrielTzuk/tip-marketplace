...
from consts import (
    ...
    ENABLE_SERVICE_ACCOUNT_SCRIPT_NAME
)
...
def main():
    ...
    siemplify.script_name = f"{INTEGRATION_IDENTIFIER} - {ENABLE_SERVICE_ACCOUNT_SCRIPT_NAME}"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                manager.enable_service_account(entity.identifier.strip())
        ...
        if successful_entities:
            output_message += "Successfully enabled the following service accounts:\n   {}".format(
            ...
            output_message += "No service accounts were enabled."

    except Exception as error:
        output_message = f"Error executing action \"{ENABLE_SERVICE_ACCOUNT_SCRIPT_NAME}\". Reason: {error}"
