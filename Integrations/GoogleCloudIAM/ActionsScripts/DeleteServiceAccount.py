...
from consts import (
    ...
    DELETE_SERVICE_ACCOUNT_SCRIPT_NAME
)
...
def main():
    ...
    siemplify.script_name = f"{INTEGRATION_IDENTIFIER} - {DELETE_SERVICE_ACCOUNT_SCRIPT_NAME}"
    ...
    try:
        ...
        for entity in siemplify.target_entities:
            ...
            try:
                ...
                manager.delete_service_account(entity.identifier.strip())
        ...
        if successful_entities:
            output_message += "Successfully deleted the following service accounts:\n   {}".format(
            ...
            output_message += "No service accounts were deleted."

    except Exception as error:
        output_message = f"Error executing action \"{DELETE_SERVICE_ACCOUNT_SCRIPT_NAME}\". Reason: {error}"
