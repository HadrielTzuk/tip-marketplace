...
def main():
    ...
    siemplify.script_name = ADD_ATTRIBUTE_SCRIPT
    ...
    attribute_source = extract_action_param(
        siemplify,
        param_name="Attribute Source",
        is_mandatory=False,
        print_value=True,
    )
    ...
    try:
        ...
        universal_object = threatq_manager.add_attribute_to_object(
        ...
        output_message = u'Successfully added attribute {} to {} object in ThreatQ'.format(attribute_name, object_type)
        result_value = True
        ...
        output_message = u'Action was not able to add attribute {} to the ThreatQ object.'.format(attribute_name)
        siemplify.LOGGER.error(output_message)
        siemplify.LOGGER.exception(e)
        result_value = False
        execution_status = EXECUTION_STATE_COMPLETED
        ...
        output_message = u'Error executing action \"Add Attribute\". Reason: {}'.format(e)
        siemplify.LOGGER.error(output_message)
        siemplify.LOGGER.exception(e)
        result_value = False
