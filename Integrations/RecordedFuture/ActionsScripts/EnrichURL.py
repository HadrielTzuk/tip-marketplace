...
from constants import PROVIDER_NAME, ENRICH_URL_SCRIPT_NAME, DEFAULT_THRESHOLD
...
def main():
    ...
    recorded_future_common.enrich_common_logic([EntityTypes.URL], threshold, ENRICH_URL_SCRIPT_NAME,
