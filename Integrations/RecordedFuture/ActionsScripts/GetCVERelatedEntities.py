...
from constants import PROVIDER_NAME, GET_CVE_RELATED_ENTITIES_SCRIPT_NAME


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = GET_CVE_RELATED_ENTITIES_SCRIPT_NAME
    ...
    recorded_future_common.get_related_entities_logic([EntityTypes.CVE], GET_CVE_RELATED_ENTITIES_SCRIPT_NAME)
