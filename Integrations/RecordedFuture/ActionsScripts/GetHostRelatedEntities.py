...
from constants import PROVIDER_NAME, GET_HOST_RELATED_ENTITIES_SCRIPT_NAME
...
def main():
    ...
    recorded_future_common.get_related_entities_logic([EntityTypes.HOSTNAME], GET_HOST_RELATED_ENTITIES_SCRIPT_NAME)
