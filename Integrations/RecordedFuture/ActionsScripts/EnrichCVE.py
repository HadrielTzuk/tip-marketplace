...
from constants import PROVIDER_NAME, ENRICH_CVE_SCRIPT_NAME, DEFAULT_THRESHOLD


@output_handler
def main():
    siemplify = SiemplifyAction()
    siemplify.script_name = ENRICH_CVE_SCRIPT_NAME
    ...
    recorded_future_common.enrich_common_logic([EntityTypes.CVE], threshold, ENRICH_CVE_SCRIPT_NAME,
