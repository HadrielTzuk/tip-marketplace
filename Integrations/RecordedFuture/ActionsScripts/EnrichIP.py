...
from constants import PROVIDER_NAME, ENRICH_IP_SCRIPT_NAME, DEFAULT_THRESHOLD
...
def main():
    ...
    recorded_future_common.enrich_common_logic([EntityTypes.ADDRESS], threshold, ENRICH_IP_SCRIPT_NAME,
