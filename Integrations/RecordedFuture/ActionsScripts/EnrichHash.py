...
from constants import PROVIDER_NAME, ENRICH_HASH_SCRIPT_NAME, DEFAULT_THRESHOLD
...
def main():
    ...
    recorded_future_common.enrich_common_logic([EntityTypes.FILEHASH], threshold, ENRICH_HASH_SCRIPT_NAME,
