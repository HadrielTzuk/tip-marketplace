...
def main(is_test_run):
    ...
    limit = extract_connector_param(siemplify, param_name="Max Alerts To Fetch", input_type=int,
                                    default_value=DEFAULT_LIMIT, print_value=True)
    dynamic_list_as_blocklist = extract_connector_param(siemplify, "Use dynamic list as a blocklist", is_mandatory=True,
    ...
    try:
        ...
        for alert in filtered_alerts:
            try:
                ...
                if not pass_filters(siemplify, dynamic_list_as_blocklist, alert, "model"):
        ...
        if not is_test_run:
            ...
            save_timestamp(siemplify=siemplify, alerts=fetched_alerts, timestamp_key="created_datetime")
