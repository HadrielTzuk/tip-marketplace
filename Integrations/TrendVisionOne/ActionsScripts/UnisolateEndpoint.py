        ...
        try:
            ...
            if endpoint:
                if endpoint.guid in result_data["result_endpoints"]:
                    ...
                    result_url = manager.unisolate_endpoint(
...
def generate_output_message_and_result(result_data):
    ...
    if result_data["completed"]:
        ...
        output_message = "None of the provided endpoints were unisolated."
        result_value = False
...
def main(is_first_run):
    ...
    try:
        ...
        output_message = 'Error executing action {}. Reason: {}'.format(UNISOLATE_ENDPOINT_SCRIPT_NAME, e)
        status = EXECUTION_STATE_FAILED
        result_value = False
        siemplify.LOGGER.error(output_message)
        siemplify.LOGGER.exception(e)
