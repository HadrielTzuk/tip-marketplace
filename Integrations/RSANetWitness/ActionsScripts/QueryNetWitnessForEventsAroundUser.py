...
def main():
    ...
    for entity in scope_entities:
        # Get meta.
        csv_output = rsa_manager.get_events_for_user(entity.identifier, csv_format=True)
        json_output = rsa_manager.get_events_for_user(entity.identifier)
        # Get pcap data.
        pcap_byte_array = rsa_manager.get_pcap_for_user(entity.identifier)
