...
def main():
    ...
    for entity in scope_entities:
        csv_output = rsa_manager.get_events_for_ip(entity.identifier, csv_format=True)
        json_output = rsa_manager.get_events_for_ip(entity.identifier)
        pcap_byte_array = rsa_manager.get_pcap_for_ip(entity.identifier)
        if json_output:
